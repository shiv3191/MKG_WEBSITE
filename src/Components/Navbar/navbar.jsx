  ...
  return (
    <nav className={`container ${sticky ? 'dark-nav' : ''}`}>
      ...
      <ul className={stick ? '' : "hide-menu-icon"}>
        ...
        <li><Link to='contact' smooth={true} offset={-260} duration={500}>Research</Link></li>
        <li><Link to='contact' smooth={true} offset={-260} duration={500}>Teaching</Link></li>
        <li><Link to='contact' smooth={true} offset={-260} duration={500}>Other Activities</Link></li>
        <li><Link to='contact' smooth={true} offset={-260} duration={500}>Position Available</Link></li>
      </ul>
